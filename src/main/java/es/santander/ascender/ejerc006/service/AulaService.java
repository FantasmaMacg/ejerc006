...
public class AulaService {
    ...
    public Aula create(Aula aula) {
        if (aula.getId() != null) {
            throw new CrudSecurityException("Han tratado de modificar un registro aula utilizando la creación",
    ...
    public Aula update(Aula aula) {
        if (aula.getId() == null) {
            throw new CrudSecurityException("Han tratado de crear un registro aula utilizando la modificación",
